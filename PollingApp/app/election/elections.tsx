            ...
            {filteredElections.some(election => !election.is_expired) && (
              <View>
                <Text style={{
                  ...
                  <Ionicons name="time-outline" size={18} /> Active Elections
                </Text>
                {filteredElections
                  .filter(election => !election.is_expired)
                  .map((election) => (
                    <TouchableOpacity
                      key={election.id}
            ...
            {filteredElections.some(election => election.is_expired) && (
              <View>
                <Text style={{
                  ...
                  <Ionicons name="checkmark-done-outline" size={18} /> Completed Elections
                </Text>
                {filteredElections
                  .filter(election => election.is_expired)
                  .map((election) => (
                    ...
                    >
                      ...
                      <View style={styles.electionDetail}>
                        <Ionicons name="calendar-outline" size={16} color="#666" style={{ marginRight: 6 }} />
                        <Text>Ended: {formatDate(election.end_date)}</Text>
                      </View>
